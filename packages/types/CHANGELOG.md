...
- [#3061](https://github.com/chakra-ui/zag/pull/3061)
  [`3f9db62`](https://github.com/chakra-ui/zag/commit/3f9db62002a581ba2e948b289a633be76d66623b) Thanks
  [@github-actions](https://github.com/apps/github-actions)! - **Breaking:** Replace
  `data-scope`/`data-part`/`data-ownedby` with a single merged attribute `data-{scope}-{part}="{uid}"`.
